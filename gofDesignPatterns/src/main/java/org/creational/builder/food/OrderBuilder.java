                ...
                switch (vegpizzachoice) {
                    case 1 -> {
                        ...
                        switch (cheezepizzasize) {
                            case 1 -> itemsOrder.addItems(new SmallCheezePizza());
                            case 2 -> itemsOrder.addItems(new MediumCheezePizza());
                            case 3 -> itemsOrder.addItems(new LargeCheezePizza());
                            case 4 -> itemsOrder.addItems(new ExtraLargeCheezePizza());
                        }
                        break;
                    }
                    case 2 -> {
                        ...
                        switch (onionpizzasize) {
                            case 1 -> itemsOrder.addItems(new SmallOnionPizza());
                            case 2 -> itemsOrder.addItems(new MediumOnionPizza());
                            case 3 -> itemsOrder.addItems(new LargeOnionPizza());
                            case 4 -> itemsOrder.addItems(new ExtraLargeOnionPizza());
                        }
                    }
                    case 3 -> {
                        ...
                        switch (masalapizzasize) {
                            case 1 -> itemsOrder.addItems(new SmallMasalaPizza());
                            case 2 -> itemsOrder.addItems(new MediumMasalaPizza());
                            case 3 -> itemsOrder.addItems(new LargeMasalaPizza());
                            case 4 -> itemsOrder.addItems(new ExtraLargeMasalaPizza());
                        }
...
// Veg- pizza choice completed.
            ...
            case 2 -> {
                ...
                switch (nonvegpizzasize) {
                    case 1 -> itemsOrder.addItems(new SmallNonVegPizza());
                    case 2 -> itemsOrder.addItems(new MediumNonVegPizza());
                    case 3 -> itemsOrder.addItems(new LargeNonVegPizza());
                    case 4 -> itemsOrder.addItems(new ExtraLargeNonVegPizza());
                }
