...
public class Book {
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(amountOfPages, id, name, price, publisher, publishingYear);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Book other = (Book) obj;
		return amountOfPages == other.amountOfPages && Arrays.equals(authors, other.authors) && id == other.id
