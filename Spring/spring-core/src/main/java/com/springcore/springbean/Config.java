...
@Configuration
// The @ComponentScan annotation is used with the @Configuration annotation to tell Spring the packages to scan for annotated components. In this case, it's scanning the package where the Company class is located.
@ComponentScan(basePackageClasses = Company.class)
public class Config {
    // The main method which will be executed when the application starts
    public static void main(String[] args) {
        // Creating a new Spring ApplicationContext by providing configuration instructions defined in the Config class
