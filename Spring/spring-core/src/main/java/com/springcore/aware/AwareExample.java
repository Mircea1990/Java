...
public class AwareExample {
    public static void main(String[] args) {
        // Creating a new AnnotationConfigApplicationContext, passing in the AwareConfig class to the constructor.
        // This will bootstrap the Spring application context, registering all the beans defined in AwareConfig.
