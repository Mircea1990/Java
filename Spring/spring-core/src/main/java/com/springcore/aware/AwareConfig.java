...
@ComponentScan("com.springcore.aware") public class AwareConfig {
    ...
    @Bean(name = "myCustomBeanName") public MyBeanName getMyBeanName() {
    ...
    @Bean public MyBeanFactory getMyBeanFactory() {
