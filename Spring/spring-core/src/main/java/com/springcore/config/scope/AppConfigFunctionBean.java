...
public class AppConfigFunctionBean {
    // This annotation is used to automatically inject an instance of ApplicationContext into this class.
    @Autowired
    private ApplicationContext context;

    // This method is annotated with @Bean, indicating that it returns an object that should be registered as a bean in the Spring application context.
    ...
    // It retrieves the PrototypeBean from the application context, sets its name, and then returns it.
