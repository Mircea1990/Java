...
public class CopyStream {
    ...
    public static String getStringFromInputStream(InputStream input) throws IOException {
        ...
        // Using IOUtils.copy() method to copy the InputStream content to the StringWriter. The content is decoded using UTF-8 character encoding.
        IOUtils.copy(input, writer, "UTF-8");
        // Converting the StringWriter content to a String and returning it
        return writer.toString();
    }

    // This method returns an InputStream that does not close the underlying stream when it is closed
    public InputStream getNonClosingInputStream() throws IOException {
        ...
        // Wrapping the InputStream with a non-closing InputStream using StreamUtils.nonClosing() method and returning it
