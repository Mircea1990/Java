...
public class Teacher {
    // The @Autowired annotation provides control over where and how autowiring should be accomplished.
    ...
    // Here it is used to autowire the ApplicationContext, which is an interface representing the Spring IoC container.
    @Autowired
