...
// The string "schoolNotification" is the specific name of the bean to be created, instead of the
// default one.
...
// Here it is set to ConfigurableBeanFactory.SCOPE_PROTOTYPE, which means a new instance will be
// created each time an injection is performed.
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE) public class SchoolNotification {
    // The @Autowired annotation is used to autowire spring bean on setter methods, instance
    ...
    // This is the constructor of the SchoolNotification class. It initializes the name with the
    // provided value and creates a new ArrayList for marks.
    public SchoolNotification(String name) {
        this.name = name;
        this.marks = new ArrayList<Integer>();
    }

    // This method adds a mark to the collection and then uses the Grader instance to grade the
    // updated collection.
