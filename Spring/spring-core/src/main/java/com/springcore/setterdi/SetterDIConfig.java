...
@Configuration
// This annotation is used with @Configuration to allow Spring to automatically scan the classes
// of specified packages
@ComponentScan("com.springcore.setterdi") public class SetterDIConfig {
    // This method is annotated with @Bean, meaning it will be instantiated, assembled, and
    ...
    // This method is annotated with @Bean, meaning it will be instantiated, assembled, and
    // managed by Spring IoC container
    @Bean public Transmission transmission() {
