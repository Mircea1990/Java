...
public class AppConfig2 {
    ...
    // This annotation is used to specify the scope of the bean. In this case, a new instance
    // will be created every time the bean is requested.
    ...
    public SingletonObjectFactoryBean singletonObjectFactoryBean() {
        return new SingletonObjectFactoryBean(); // Returns a new instance of
    ...
    public Provider<PrototypeBean> prototypeBeanProvider() {
        return this::prototypeBean; // Returns a provider for PrototypeBeans. The provider's get
        // () method will return a new instance each time because PrototypeBeans are prototype
        // scoped.
    }
    ...
    public Function<String, PrototypeBean> prototypeBeanFactory() {
        return name -> prototypeBean(); // Returns a function that can produce PrototypeBeans.
        // The function takes a string (name) as input but doesn't use it, and returns a new
        // PrototypeBean each time it's called because PrototypeBeans are prototype scoped.
    }
}
