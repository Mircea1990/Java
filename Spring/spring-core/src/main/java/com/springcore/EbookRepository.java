...
@Repository
// This interface extends JpaRepository, specifying the domain type as Ebook and the id type as Integer.
// JpaRepository is a JPA specific extension of Repository which contains methods for performing standard CRUD operations.
