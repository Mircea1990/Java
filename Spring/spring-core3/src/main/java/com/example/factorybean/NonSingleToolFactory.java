...
@Getter public class NonSingleToolFactory extends AbstractFactoryBean<Tool> {
    // These are the private fields for factoryId and toolId.
    private int factoryId;
    private int toolId;

    // This is the constructor of NonSingleToolFactory. It sets the singleton property to false,
    // meaning that each request for this bean will return a separate instance.
