...
@ContextConfiguration(classes = {NotEligibleForAutoProxyRandomIntProcessor.class, DataCache.class,
        RandomIntGenerator.class}) public class NotEligibleForAutoProxyingIntegrationTest {
    ...
    // This test method checks if a specific log message is present when the Spring context is
    // initialized
    @Test
