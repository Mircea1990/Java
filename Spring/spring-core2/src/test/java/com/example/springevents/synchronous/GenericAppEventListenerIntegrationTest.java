...
public class GenericAppEventListenerIntegrationTest {
    ...
    @Autowired private GenericSpringEventListener listener;
    ...
    @Test public void testGenericSpringEvent() {
        // Assert that the event handler was not hit initially. If not, it will throw an
        ...
        // Assert that the event handler was hit after the event was published. If not, it will
