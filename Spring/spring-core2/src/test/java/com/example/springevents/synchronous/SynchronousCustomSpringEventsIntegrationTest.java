...
public class SynchronousCustomSpringEventsIntegrationTest {
    ...
    public void testCustomSpringEvents() {
        // Assert that the custom event handler was not hit initially. If not, it will throw an AssertionError with the given message.
        ...
        // Assert that the custom event handler was hit after the event was published. If not, it will throw an AssertionError with the given message.
        isTrue(listener.isHitCustomEventHandler(), "Now the value should be changed to true");
    }

    @Test
    public void testGenericSpringEvent() {
        // Assert that the successful event handler was not hit initially. If not, it will throw an AssertionError with the given message.
        ...
        // Assert that the successful event handler was hit after the successful event was published. If not, it will throw an AssertionError with the given message.
    ...
    public void testGenericSpringEventNotProcessed() {
        ...
        // Assert that the successful event handler was still not hit after the unsuccessful event was published. If not, it will throw an AssertionError with the given message.
    ...
    public void testContextStartedEvent() {
        // Assert that the context started handler was hit once. If not, it will throw an AssertionError with the given message.
