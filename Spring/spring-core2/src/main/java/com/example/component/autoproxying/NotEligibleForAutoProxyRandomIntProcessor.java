...
// This class implements the BeanPostProcessor interface which allows for custom modification of new bean instances.
public class NotEligibleForAutoProxyRandomIntProcessor implements BeanPostProcessor {
    ...
    // This static method takes an Object and a RandomIntGenerator as parameters and returns an Object.
    // It gets all declared fields of the bean's class and checks each field for the presence of the RandomInt annotation.
    // If the annotation is present, it generates a random value within the specified range and sets it to the field.
