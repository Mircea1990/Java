...
public class CoreConfig implements WebMvcConfigurer {  // This class implements the WebMvcConfigurer
    ...
    public ExecutorService setupExecutor() {  // This method creates a ThreadPoolExecutor bean.
        final int coreThreads =
                4;  // The number of threads to keep in the pool, even if they are idle.
        final int maxThreads = 8;  // The maximum number of threads to allow in the pool.
        final ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(coreThreads,
                                                                             maxThreads, 60L,
                                                                             TimeUnit.SECONDS,
        ...
        threadPoolExecutor.allowCoreThreadTimeOut(
                true);  // Sets the policy governing whether core threads may time out and
