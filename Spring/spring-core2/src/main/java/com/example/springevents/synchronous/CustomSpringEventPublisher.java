...
@Component public class CustomSpringEventPublisher {
    // The @Autowired annotation allows Spring to resolve and inject collaborating beans into our
    // bean.
    ...
    public void publishGenericEvent(final String message, boolean success) {
        ...
        final GenericSpringEvent<String> genericSpringEvent = new GenericStringSpringEvent(message,
                                                                                           success);
        // It publishes the event to the application context.
    ...
    public void publishGenericAppEvent(final String message) {
        ...
        final GenericSpringAppEvent<String> genericSpringEvent = new GenericStringSpringAppEvent(
                this, message);
        // It publishes the event to the application context.
        applicationEventPublisher.publishEvent(genericSpringEvent);
    }
