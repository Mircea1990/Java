...
public class ProductController {
    ...
    // @GetMapping is a composed annotation that acts as a shortcut for @RequestMapping(method = GET).
    ...
    public Stock getProductStock(@PathVariable("id") int productId) {
        // Fetch the product by id from the productService, get its stock details. If not found, return null.
        return productService.getProductById(productId)
