...
// current package, allowing it to find controllers.
@SpringBootApplication public class ConcurrentRequestApplication {
    // The main method serves as an entry point for the application.
    public static void main(String[] args) {
        // The SpringApplication.run method launches an application. Here it's launching the
        // ConcurrentRequestApplication.
