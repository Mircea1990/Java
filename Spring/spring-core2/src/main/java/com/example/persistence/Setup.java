...
@Component public class Setup implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override public final void onApplicationEvent(@NonNull final ContextRefreshedEvent event) {
