...
public class PhaserDemo {
	...
	private static class Task implements Runnable {
		...
		@Override
		public void run() {
			System.out.println("Arrived in thread before try-catch: " + Thread.currentThread().getName());
			System.out.println("Arrived phase before try-catch: " + phaser.arriveAndAwaitAdvance());
			try {
