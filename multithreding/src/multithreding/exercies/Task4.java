...
public class Task4 {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		System.out.println("Time of multithreading search: " + se.getTimeOfSingleThreadingSearch());

		System.out.println("\nPrinting the future list:");
	...
	private static class SearchEngine {
		 ...
		 */
		private long timeOfSingleTreadingSearch;
		...
		public long getTimeOfSingleThreadingSearch() {
			return timeOfSingleTreadingSearch;
		}
		...
		public int getMaxElementInMatrixMultiThreading() throws InterruptedException, ExecutionException {
			...
			maxIntMatrix = findMaxOfAllThreads(futureList);
		...
		public int getMaxElementInMatrixSingleThreading() throws InterruptedException {
			...
			long finish = System.nanoTime();
			timeOfSingleTreadingSearch = (finish - start) / 1_000_000;
			return max;
		}
