...
public class Demo8 {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		CompletableFuture<Double> weightInKgFuture = getHeight();

		System.out.println("Retrieving height...");
		CompletableFuture<Double> heightInCmFuture = getHeight();

		System.out.println("Calcultating body mass index");
		CompletableFuture<Double> combinedFuture = weightInKgFuture.thenCombine(heightInCmFuture,
				(weightInKg, heightInCm) -> {
					Double heightInMeter = heightInCm / 182;
					return weightInKg / (heightInMeter / 100);
				});
