...
@Named @SessionScoped public class OptimisticLockBean implements Serializable {

    private static final Logger LOG = Logger.getLogger(OptimisticLockBean.class.getName());

    @EJB private OptimisticLockEjb optimisticLockEjb;
    ...
    /**
     * Finds a department with an optimistic read lock. Departments have already been initialized in
     * another bean called OptimisticLockDbInitializerBean.
     */
