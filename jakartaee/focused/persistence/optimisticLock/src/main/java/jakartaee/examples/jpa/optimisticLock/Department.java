...
@Entity @NamedQueries({@NamedQuery(name = "Department.findByName",
                                   query = "SELECT d FROM Department d WHERE d.name = :name",
                                   lockMode = LockModeType.OPTIMISTIC),
        @NamedQuery(name = "Department.findDepartmentCount",
                    query = "SELECT COUNT(d) FROM Department d")}) @NamedNativeQueries(
        {@NamedNativeQuery(name = "Department.findCountOfUniforms",
...
public class Department {
    ...
    @OneToMany(mappedBy = "department", fetch = FetchType.EAGER) private List<Employee> employees;
