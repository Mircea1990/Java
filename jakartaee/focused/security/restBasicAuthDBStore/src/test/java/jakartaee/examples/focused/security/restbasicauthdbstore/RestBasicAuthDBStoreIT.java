...
/**
 * The integration test for the REST with basic authentication and database example
 */
@RunWith(Arquillian.class) @RunAsClient public class RestBasicAuthDBStoreIT extends ITBase {
