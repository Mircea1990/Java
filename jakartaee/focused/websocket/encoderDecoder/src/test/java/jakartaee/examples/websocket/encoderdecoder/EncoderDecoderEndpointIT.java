 ...
 */
@ClientEndpoint(encoders = EncoderDecoderEncoder.class, decoders = EncoderDecoderDecoder.class)
@RunWith(Arquillian.class) public class EncoderDecoderEndpointIT extends ITBase {
     ...
     */
    @OnMessage public void onMessage(Session session, EncoderDecoder encoderDecoder) {
     ...
     */
    @Test @RunAsClient public void testClientEndpoint() throws Exception {
        countDown = new CountDownLatch(1);

        ClientManager client = ClientManager.createClient();
        StringBuilder wsUrl = new StringBuilder();
        wsUrl.append("ws://").append(baseUrl.getHost()).append(":").append(baseUrl.getPort())
             .append(baseUrl.getPath()).append("echo");
