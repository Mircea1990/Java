package jakarta.tutorial.convertersecure.web;
...
import jakarta.tutorial.convertersecure.ejb.ConverterBean;

@WebServlet(urlPatterns = "/") @ServletSecurity(
        @HttpConstraint(transportGuarantee = TransportGuarantee.CONFIDENTIAL,
                        rolesAllowed = {"TutorialUser"})) public class ConverterServlet
        extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (amount != null && amount.length() > 0) {
                ...
                out.println(
                        "<p>" + amount + " dollars are " + yenAmount.toPlainString() + " yen.</p>");
                ...
                out.println(
                        "<p>$ <input title=\"Amount\" type=\"text\" name=\"amount\" " +
                        "size=\"25\"></p>");
                out.println("<br/>");
