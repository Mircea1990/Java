 ...
 */
@Named @SessionScoped public class JsonbBean implements Serializable {
    ...
    /**
     * Action method for the form in index.xhtml. Creates Person object and creates formatted JSON
     */
    ...
    /**
     * Action method for form in jsongenerated.xhtml. Deserialize JSON from the textarea to Person
     * object and fills these data to form.
     */
