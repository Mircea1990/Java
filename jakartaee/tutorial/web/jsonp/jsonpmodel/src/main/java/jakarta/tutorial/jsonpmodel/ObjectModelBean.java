package jakarta.tutorial.jsonpmodel;
...
@Named @SessionScoped public class ObjectModelBean implements Serializable {
    ...
    public String buildJson() {
        ...
        JsonObject model = Json.createObjectBuilder().add("firstName", firstName).add("lastName",
                                                                                      lastName).add(
                                       "age", age).add("streetAddress", streetAddress).add("city"
                                       , city).add("state",
                                                                                                             state).add(
                                       "postalCode", postalCode).add("phoneNumbers",
