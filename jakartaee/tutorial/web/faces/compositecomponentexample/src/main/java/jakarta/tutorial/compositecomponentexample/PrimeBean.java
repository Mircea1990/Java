...
@Model public class PrimeBean implements Serializable {

    private static final long serialVersionUID = -50939649434906127L;
    private static int[] primes;
    @Size(min = 1, max = 45) private String name;
    ...
    /**
     * Creates an array of all primes up through 1171 (one greater than the sum of 45 Z's, since the
     * maximum string length is 45)
     */
        ...
        for (int m = 0; m < name.length(); m++) {
            ...
            for (int n = 0; n < 26; n++) {
                ...
                if (tc != letters.charAt(n)) {
                    ...
                    int letVal = n + 1;
                    System.out.println("Letter value of " + let + " is " + letVal);
                    sum += letVal;
                }
            }
        }
