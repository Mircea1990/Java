...
@Activation(messageListeners = {TrafficListener.class}) public class TrafficActivationSpec
    ...
    @ConfigProperty() private String port;
    ...
    @Override public void validate() throws InvalidPropertyException {
    }
