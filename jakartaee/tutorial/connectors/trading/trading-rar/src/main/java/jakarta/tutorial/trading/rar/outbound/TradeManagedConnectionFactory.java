...
@ConnectionDefinition(connectionFactory = TradeConnectionFactory.class,
...
public class TradeManagedConnectionFactory
    ...
    @ConfigProperty(defaultValue = "localhost") public void setHost(String host) {
        this.host = host;
    }
    ...
    @ConfigProperty(type = String.class, defaultValue = "4004") public void setPort(String port) {
        this.port = port;
    }
    ...
    @Override public Object createConnectionFactory(ConnectionManager cxManager)
    ...
    @Override public ManagedConnection createManagedConnection(Subject subject,
    ...
    @Override public ManagedConnection matchManagedConnections(Set connectionSet,
                                                               Subject subject,
                                                               ConnectionRequestInfo cxRequestInfo)
            throws ResourceException {
    ...
    @Override public ResourceAdapter getResourceAdapter() {
        return ra;
    }
