...
public class TradeManagedConnection implements ManagedConnection {
    ...
    @Override public Object getConnection(Subject subject, ConnectionRequestInfo cinfo)
    ...
    @Override public ManagedConnectionMetaData getMetaData() throws ResourceException {
        return new ManagedConnectionMetaData() {
            @Override public String getEISProductName() throws ResourceException {
                return "MegaTrade Execution Platform";
            }

            @Override public String getEISProductVersion() throws ResourceException {
                return "7.0";
            }

            @Override public int getMaxConnections() throws ResourceException {
                return 0;
            }

            @Override public String getUserName() throws ResourceException {
                return "defaultUser";
            }
        };
    }
