...
@Entity @XmlRootElement(name = "Person") public class Person implements Serializable {
    ...
    @OneToMany protected List<Address> addresses;
    @OneToOne protected PersonDetails details;
    @XmlTransient protected String password;
