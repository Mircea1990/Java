...
@Entity public class PersonDetails implements Serializable {
    private static final long serialVersionUID = 2921499531009567911L;
    @OneToOne(mappedBy = "details", cascade = CascadeType.ALL) protected Person person;
    @Lob @XmlTransient protected byte[] photo;
    @Past @Temporal(TemporalType.DATE) protected Date birthday;
