...
@Path("/tutoring/admin") @Stateless @Named public class AdminBean {
    ...
    public String createStudent(Student student) {
        logger.log(Level.INFO, "AdminBean.createStudent(1 arg): Persisting new student.");
        em.persist(student);
    ...
    public Guardian createGuardian(String firstName,
                                   String middleName,
                                   String lastName,
                                   String nickname,
                                   String suffix,
                                   ...
                                   String mobilePhone,
                                   Student student) {
        logger.log(Level.INFO, "AdminBean.createGuardian(9 args): Persisting new guardian.");
    ...
    public Address createAddress(String street1,
                                 String street2,
                                 String city,
                                 String province,
                                 String country,
