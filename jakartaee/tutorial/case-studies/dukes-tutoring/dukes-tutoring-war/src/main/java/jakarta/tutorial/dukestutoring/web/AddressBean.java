...
@Named @RequestScoped public class AddressBean {
    ...
    @NotNull @Digits(integer = 5, fraction = 0, message = "{invalid.zipcode}") private String
            postalCode;
    ...
    public String submit(Student student) {
        ...
        this.address = adminBean.createAddress(street1, street2, city, province, country,
                                               postalCode, isPrimary, student);
