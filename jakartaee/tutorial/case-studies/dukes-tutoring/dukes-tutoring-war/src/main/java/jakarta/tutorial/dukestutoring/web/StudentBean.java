...
@Named @RequestScoped public class StudentBean {
    ...
    public String submit() {
        ...
        this.student = adminBean.createStudent(firstName, middleName, lastName, nickname, suffix,
                                               school, grade, email, homePhone, mobilePhone);
