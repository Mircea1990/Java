...
@Named @RequestScoped public class GuardianBean {

    private static final Logger logger = Logger.getLogger("dukestutoring.web.GuardianBean");
    ...
    public List<Guardian> getAllGuardians() {
        if (allGuardians == null) {
            try {
                ...
                logger.log(Level.SEVERE, "adminBean.getAllGuardians returned an error{0}",
                           ex.getMessage());
            }
        }
    ...
    public String submit(Student student) {
        ...
        this.guardian = adminBean.createGuardian(firstName, middleName, lastName, nickname, suffix,
                                                 email, homePhone, mobilePhone, student);
