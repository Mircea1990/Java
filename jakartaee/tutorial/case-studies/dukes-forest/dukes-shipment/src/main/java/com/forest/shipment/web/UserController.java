...
/**
 * UserController is an authorization controller responsible for user login/logout actions
 */
@Named(value = "userController") @SessionScoped public class UserController
        implements Serializable {

    private static final long serialVersionUID = -7440104826420270291L;

    @Inject ShippingBean adapter;

    Person user;
    @EJB private UserBean ejbFacade;
    ...
    public @Produces @LoggedIn Person getAuthenticatedUser() {
        return user;
    }
