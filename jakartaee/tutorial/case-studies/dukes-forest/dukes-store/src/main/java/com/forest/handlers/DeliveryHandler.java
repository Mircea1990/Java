...
@Stateless public class DeliveryHandler implements IOrderHandler, Serializable {
    ...
    @EJB OrderJMSManager orderPublisher;

    @Override @Asynchronous public void onNewOrder(@Observes @Paid OrderEvent event) {
        ...
        try {
            logger.log(Level.INFO,
                       "Order #{0} has been paid in the amount of {1}. Order is now ready for " +
                       "delivery!",
