...
@Named(value = "customerController") @SessionScoped public class CustomerController
    ...
    @Inject @LoggedIn Person authenticated;
    private Customer current;
    private DataModel items = null;
    @EJB private com.forest.ejb.UserBean ejbFacade;
    ...
    public AbstractPaginationHelper getPagination() {
        if (pagination == null) {
            pagination = new AbstractPaginationHelper(AbstractPaginationHelper.DEFAULT_SIZE) {
                ...
                @Override public DataModel createPageDataModel() {
        ...
        try {
            if (!isUserDuplicated(current)) {
                ...
                JsfUtil.addSuccessMessage(
                        ResourceBundle.getBundle(BUNDLE).getString("CustomerCreated"));

            } else {
                JsfUtil.addErrorMessage(
                        ResourceBundle.getBundle(BUNDLE).getString("DuplicatedCustomerError"));
    ...
    public PageNavigation update() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CustomerUpdated"));
            return PageNavigation.VIEW;
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CustomerDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
        }
    ...
    @FacesConverter(forClass = Customer.class) public static class CustomerControllerConverter
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            CustomerController controller =
                    (CustomerController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "customerController");
