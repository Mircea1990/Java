...
@Named(value = "categoryController") @SessionScoped public class CategoryController
    ...
    @EJB private com.forest.ejb.CategoryBean ejbFacade;
    ...
    public PageNavigation create() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CategoryCreated"));
            recreateModel();
    ...
    public PageNavigation update() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CategoryUpdated"));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CategoryDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
        }
    ...
    @FacesConverter(forClass = Category.class) public static class CategoryControllerConverter
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            CategoryController controller =
                    (CategoryController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "categoryController");
