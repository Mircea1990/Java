...
@Named(value = "orderStatusController") @RequestScoped public class OrderStatusController {
    private static final String BUNDLE = "bundles.Bundle";

    private OrderStatus current;
    private DataModel items = null;
    @EJB private com.forest.ejb.OrderStatusBean ejbFacade;
    ...
    public PageNavigation create() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("OrderStatusCreated"));
    ...
    public PageNavigation update() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("OrderStatusUpdated"));
            return PageNavigation.VIEW;
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("OrderStatusDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
        }
    ...
    @FacesConverter(forClass = OrderStatus.class) public static class OrderStatusControllerConverter
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            OrderStatusController controller =
                    (OrderStatusController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "orderStatusController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof OrderStatus) {
                ...
                throw new IllegalArgumentException(
                        ...
                        "; expected type: " + OrderStatusController.class.getName());
            }
        }
    }
}
