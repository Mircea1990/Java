...
/**
 * Image servlet based on BalusC (@link below) implementation balusc
 *
 * @link http://balusc.blogspot.com/2007/04/imageservlet.html
 */
@WebServlet(urlPatterns = "/image/*") public class ImageServlet extends HttpServlet {
    ...
    @EJB ProductBean productBean;
    //private final String UPLOAD_DIR = ResourceBundle.getBundle("bundles.Bundle").getString
    // ("UPLOAD_LOCATION");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                logger.log(Level.SEVERE, "Problems during image resource manipulation. {0}",
                           e.getMessage());
            }
        }
    }
    ...
    @Override protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((p == null) || (p.getImgSrc() == null)) {
            ...
            File image = new File(getServletContext().getRealPath(UPLOAD_DIR), URLDecoder.decode
