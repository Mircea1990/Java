...
@Named(value = "productController") @SessionScoped public class ProductController
    ...
    @EJB private com.forest.ejb.ProductBean ejbFacade;
            ...
            if (!EXTENSIONS_ALLOWED.contains(extension)) {
                ...
                JsfUtil.addErrorMessage(new Exception("Error trying to upload file"),
                                        ResourceBundle.getBundle(BUNDLE)
                                                      .getString("Error trying to upload file"));
                //response.sendRedirect("admin/product/List.xhtml?errMsg=Error trying to upload
                // file");
                return;
            }
        ...
        if (pagination == null) {
            ...
            pagination = new AbstractPaginationHelper(AbstractPaginationHelper.DEFAULT_SIZE) {
                ...
                @Override public DataModel createPageDataModel() {
                    if (categoryId != 0) {
                        return new ListDataModel(getFacade().findByCategory(
    ...
    @FacesConverter(forClass = Product.class) public static class ProductControllerConverter
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ProductController controller =
                    (ProductController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "productController");
