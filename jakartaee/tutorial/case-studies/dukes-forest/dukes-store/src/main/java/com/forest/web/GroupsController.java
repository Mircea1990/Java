...
@Named(value = "groupsController") @SessionScoped public class GroupsController
    ...
    @EJB private com.forest.ejb.GroupsBean ejbFacade;
    ...
    @FacesConverter(forClass = Groups.class) public static class GroupsControllerConverter
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            GroupsController controller =
                    (GroupsController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "groupsController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Groups) {
                ...
                throw new IllegalArgumentException(
                        ...
                        "; expected type: " + GroupsController.class.getName());
            }
        }
    }
}
