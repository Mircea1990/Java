...
@JMSDestinationDefinition(name = "java:global/jms/OrderQueue", interfaceName = "jakarta.jms.Queue",
                          destinationName = "PhysicalOrderQueue") @Stateless
public class OrderJMSManager {
    ...
    @Resource(mappedName = "java:global/jms/OrderQueue") private Queue queue;
