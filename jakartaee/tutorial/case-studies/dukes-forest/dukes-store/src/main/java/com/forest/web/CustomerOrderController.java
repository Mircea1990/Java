...
@Named(value = "customerOrderController") @SessionScoped public class CustomerOrderController
    ...
    @Inject @LoggedIn private Person user;
    private List<CustomerOrder> myOrders;
    private CustomerOrder current;
    private DataModel items = null;
    @EJB private com.forest.ejb.OrderBean ejbFacade;
    @EJB private OrderJMSManager orderJMSManager;
    ...
    public PageNavigation create() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CustomerOrderCreated"));
    ...
    public PageNavigation update() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CustomerOrderUpdated"));
            return PageNavigation.VIEW;
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
    ...
    public PageNavigation cancelOrder() {
        ...
        try {
            ...
            ejbFacade.setOrderStatus(current.getId(),
    ...
    public List<CustomerOrder> getMyOrders() {
        ...
        if (user != null) {
            ...
            JsfUtil.addErrorMessage(
                    "Current user is not authenticated. Please do login before accessing your " +
                    "orders.");
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(
                    ResourceBundle.getBundle(BUNDLE).getString("CustomerOrderDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle(BUNDLE)
                                                     .getString("PersistenceErrorOccured"));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof CustomerOrder) {
                ...
                throw new IllegalArgumentException(
                        ...
                        "; expected type: " + CustomerOrderController.class.getName());
            }
        }
    }
}
