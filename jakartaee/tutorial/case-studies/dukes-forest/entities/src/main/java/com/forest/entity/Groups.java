...
@Entity @Table(name = "GROUPS") @NamedQueries(
...
public class Groups implements Serializable {
    ...
    @Basic(optional = false) @NotNull @Size(min = 1, max = 50, message = "{groups.name}")
    @Column(name = "NAME") private String name;
    @Size(max = 300, message = "{groups.description}") @Column(name = "DESCRIPTION") private String
            description;
    @ManyToMany(mappedBy = "groupsList") @XmlTransient @JsonbTransient private List<Person>
            personList;
    ...
    @XmlTransient @JsonbTransient public List<Person> getPersonList() {
        return personList;
    }
