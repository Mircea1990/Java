...
/**
 * <p>
 * This class converts the internal representation of a <code>UIArea</code> component into the
 * output stream associated with the response to a particular request.</p>
 */
@FacesRenderer(componentFamily = "Area", rendererType = "DemoArea") public class AreaRenderer
        extends Renderer {
