 ...
 */
@Named @SessionScoped public class AbstractBean implements Serializable {
     ...
     *
     * @param clientId Client identifier of the component this message relates to, or
     ...
     *                 <code>null</code> for global messages
     * @param key      Message key of the message to include
     * @param params   Substitution parameters for using the localized text as a message format
     */
