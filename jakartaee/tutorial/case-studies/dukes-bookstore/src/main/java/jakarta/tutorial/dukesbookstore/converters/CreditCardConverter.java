 ...
 */
@FacesConverter("ccno") public class CreditCardConverter implements Converter<String> {
     ...
     */
    @Override public String getAsObject(FacesContext context,
    ...
    /**
     * Formats the value by inserting space after every four characters for better readability if
     * they don't already exist. In the process converts any
     * <code>"-"</code> characters into blanks for consistency.
     */
    @Override public String getAsString(FacesContext context, UIComponent component, String value)
