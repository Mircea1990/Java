...
@Named @SessionScoped public class StatusManager implements Serializable {
    ...
    public List<Event> getEvents() {
        ...
        try {
            returnedEvents = client.target(baseUri).path("/status/all").request(
                    MediaType.APPLICATION_XML).get(new GenericType<List<Event>>() {});
