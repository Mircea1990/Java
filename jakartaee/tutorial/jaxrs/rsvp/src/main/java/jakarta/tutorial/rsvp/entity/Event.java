...
@XmlRootElement(name = "Event") @XmlAccessorType(XmlAccessType.FIELD) @Entity public class Event
        implements Serializable {
    private static final long serialVersionUID = -5584404843358199527L;
    @ManyToMany protected List<Person> invitees;
    protected String name;
    protected String location;
    @OneToMany(mappedBy = "event") private List<Response> responses;
    @Id @GeneratedValue(strategy = GenerationType.AUTO) private Long id;
    @ManyToOne private Person owner;
    @Temporal(TemporalType.DATE) private Date eventDate;
