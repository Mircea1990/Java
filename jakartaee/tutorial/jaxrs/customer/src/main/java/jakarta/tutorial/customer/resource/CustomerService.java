...
@Stateless @Path("/Customer") public class CustomerService {
    ...
    @GET @Path("all") @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Customer> getAllCustomers() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Error calling findAllCustomers()",
     ...
     * @param customerId
     */
    @DELETE @Path("{id}") public void deleteCustomer(@PathParam("id") String customerId) {
        try {
