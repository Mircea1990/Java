...
@Entity @Table(name = "PERSISTENCE_ROSTER_LEAGUE") public abstract class League
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "league") public Collection<Team> getTeams() {
        return teams;
    }
