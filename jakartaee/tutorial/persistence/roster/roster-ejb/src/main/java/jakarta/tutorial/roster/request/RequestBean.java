 ...
 */
@Stateful public class RequestBean implements Request, Serializable {
    ...
    @Override public void createPlayer(String id, String name, String position, double salary) {
    ...
    @Override public void addPlayer(String playerId, String teamId) {
    ...
    @Override public void removePlayer(String playerId) {
    ...
    @Override public void dropPlayer(String playerId, String teamId) {
    ...
    @Override public PlayerDetails getPlayer(String playerId) {
        logger.info("getPlayerDetails");
        try {
            Player player = em.find(Player.class, playerId);
            PlayerDetails playerDetails = new PlayerDetails(player.getId(), player.getName(),
                                                            player.getPosition(),
                                                            player.getSalary());
    ...
    @Override public List<PlayerDetails> getPlayersOfTeam(String teamId) {
    ...
    @Override public List<TeamDetails> getTeamsOfLeague(String leagueId) {
    ...
    @Override public List<PlayerDetails> getPlayersByPosition(String position) {
    ...
    @Override public List<PlayerDetails> getPlayersByHigherSalary(String name) {
        ...
        try {
            ...
            if (cq != null) {
                ...
                Predicate gtPredicate = cb.greaterThan(player1.get(Player_.salary),
    ...
    @Override public List<PlayerDetails> getPlayersBySalaryRange(double low, double high) {
    ...
    @Override public List<PlayerDetails> getPlayersByLeagueId(String leagueId) {
    ...
    @Override public List<PlayerDetails> getPlayersBySport(String sport) {
        logger.info("getPlayersByLeagueId");
        List<Player> players = null;
    ...
    @Override public List<PlayerDetails> getPlayersByCity(String city) {
    ...
    @Override public List<PlayerDetails> getAllPlayers() {
    ...
    @Override public List<PlayerDetails> getPlayersNotOnTeam() {
    ...
    @Override public List<PlayerDetails> getPlayersByPositionAndName(String position, String name) {
    ...
    @Override public List<LeagueDetails> getLeaguesOfPlayer(String playerId) {
        ...
        if (leagues == null) {
            ...
            while (i.hasNext()) {
                ...
                LeagueDetails leagueDetails = new LeagueDetails(league.getId(), league.getName(),
                                                                league.getSport());
    ...
    @Override public List<String> getSportsOfPlayer(String playerId) {
    ...
    @Override public void createTeamInLeague(TeamDetails teamDetails, String leagueId) {
    ...
    @Override public void removeTeam(String teamId) {
    ...
    @Override public TeamDetails getTeam(String teamId) {
        logger.info("getTeam");
    ...
    @Override public void createLeague(LeagueDetails leagueDetails) {
    ...
    @Override public void removeLeague(String leagueId) {
    ...
    @Override public LeagueDetails getLeague(String leagueId) {
