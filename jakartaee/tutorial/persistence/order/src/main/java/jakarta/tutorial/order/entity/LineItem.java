...
@IdClass(LineItemKey.class) @Entity @Table(name = "PERSISTENCE_ORDER_LINEITEM") @NamedQueries(
...
public class LineItem implements Serializable {
    ...
    @JoinColumn(name = "VENDORPARTNUMBER") @ManyToOne public VendorPart getVendorPart() {
        return vendorPart;
    }
    ...
    @Id @ManyToOne @JoinColumn(name = "ORDERID") public CustomerOrder getCustomerOrder() {
