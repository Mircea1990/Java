...
@SessionScoped @Named public class OrderManager implements Serializable {
    ...
    public void findVendor() {
        try {
            ...
            this.vendorSearchResults = (List<String>) request.locateVendorsByPartialName(
                    vendorName);
    ...
    public void submitOrder() {
        try {
            ...
            logger.log(Level.INFO, "Created new order with order ID {0}, status {1}, " +
                       ...
                       new Object[]{newOrderId, newOrderStatus, newOrderDiscount,
    ...
    public void addLineItem() {
        try {
            ...
            logger.log(Level.INFO, "Adding line item to order # {0}", this.currentOrder);
            //this.clearSelected();
        } catch (Exception e) {
