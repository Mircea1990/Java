...
@Entity @Table(name = "PERSISTENCE_ORDER_CUSTOMERORDER") @NamedQuery(name = "findAllOrders",
...
public class CustomerOrder implements java.io.Serializable {
    ...
    @Temporal(TemporalType.TIMESTAMP) public Date getLastUpdate() {
        return lastUpdate;
    }
    ...
    @Transient public int getNextId() {
