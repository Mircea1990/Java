...
@IdClass(PartKey.class) @Entity @Table(name = "PERSISTENCE_ORDER_PART")
...
public class Part implements Serializable {
    ...
    @Id @Column(nullable = false) public String getPartNumber() {
        return partNumber;
    }
    ...
    @Id @Column(nullable = false) public int getRevision() {
        return revision;
    }
    ...
    @Temporal(TemporalType.DATE) public Date getRevisionDate() {
        return revisionDate;
    }
    ...
    @Column(table = "PERSISTENCE_ORDER_PART_DETAIL") @Lob public Serializable getDrawing() {
        return drawing;
    }
    ...
    @Column(table = "PERSISTENCE_ORDER_PART_DETAIL") @Lob public String getSpecification() {
    ...
    @OneToMany(mappedBy = "bomPart") public List<Part> getParts() {
        return parts;
    }
    ...
    @OneToOne(mappedBy = "part") public VendorPart getVendorPart() {
        return vendorPart;
    }
