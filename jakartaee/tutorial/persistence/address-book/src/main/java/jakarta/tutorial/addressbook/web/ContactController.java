...
@Named @SessionScoped public class ContactController implements Serializable {
    ...
    @FacesConverter(forClass = Contact.class) public static class ContactControllerConverter
            implements Converter<Contact> {
        ...
        public Contact getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ContactController controller =
                    (ContactController) facesContext.getApplication().getELResolver().getValue(
                            facesContext.getELContext(), null, "contactController");
        ...
        @Override public String getAsString(FacesContext facesContext,
            ...
            if (object instanceof Contact) {
                ...
                throw new IllegalArgumentException(
                        ...
                        "; expected type: " + ContactController.class.getName());
            }
        }
