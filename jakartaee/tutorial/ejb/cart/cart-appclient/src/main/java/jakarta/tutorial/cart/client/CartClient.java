...
/**
 * The client class for the CartBean example. Client adds books to the cart, prints the contents of
 * the cart, and then removes a book which hasn't been added yet, causing a BookException.
 */
public class CartClient {
    @EJB private static Cart cart;
