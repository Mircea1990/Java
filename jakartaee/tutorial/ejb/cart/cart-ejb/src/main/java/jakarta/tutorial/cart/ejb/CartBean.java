...
@Stateful public class CartBean implements Cart, Serializable {
    ...
    @Override public void addBook(String title) {
        contents.add(title);
    }
    ...
    @Override public List<String> getContents() {
        return contents;
    }

    @Remove() @Override public void remove() {
        contents = null;
    }
}
