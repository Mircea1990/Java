...
/**
 * The SharedConsumer class consists only of a main method, which fetches one or more messages from
 * a topic using asynchronous message delivery. It uses the message listener TextListener. Run two
 * instances of this program at the same time, in conjunction with Producer.
 */
