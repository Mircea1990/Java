...
/**
 * The SharedDurableSubscriberExample class consists only of a main method, which uses a shared
 * durable topic subscriber to receive messages using asynchronous message delivery. It uses the
 * message listener TextListener. Run this program in conjunction with Producer.
 * <p>
