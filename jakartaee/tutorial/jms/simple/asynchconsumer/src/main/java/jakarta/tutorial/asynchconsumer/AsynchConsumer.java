...
/**
 * The AsynchConsumer class consists only of a main method, which receives one or more messages from
 * a queue or topic using asynchronous message delivery. It uses the message listener TextListener.
 * Run this program in conjunction with Producer.
 * <p>
 * Specify "queue" or "topic" on the command line when you run the program. To end the program,
 * enter Q or q on the command line.
 */
