...
public class ClientAckConsumer {
    ...
    public static void main(String[] args) {
        ...
        try (JMSContext context = connectionFactory.createContext(JMSContext.CLIENT_ACKNOWLEDGE);) {
            System.out.println("Created client-acknowledge JMSContext");
            ...
            while (true) {
                ...
                if (m != null) {
                    if (m instanceof TextMessage) {
                        ...
                        System.out.println("Acknowledging TextMessage");
                        context.acknowledge();
                    } else {
                        System.out.println("Acknowledging non-text control message");
                        context.acknowledge();
                        break;
                    }
                }
