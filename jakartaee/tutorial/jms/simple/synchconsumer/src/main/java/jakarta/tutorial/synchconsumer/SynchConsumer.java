...
/**
 * The SynchConsumer class consists only of a main method, which fetches one or more messages from a
 * queue or topic using synchronous message delivery. Run this program in conjunction with Producer.
