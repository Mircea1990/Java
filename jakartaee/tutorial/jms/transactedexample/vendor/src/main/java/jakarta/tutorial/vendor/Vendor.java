 ...
 * the needed number of CPUs and disk drives from its suppliers. At random intervals, it throws an
 * exception to simulate a database problem and cause a rollback.
 * <p>
...
public class Vendor {
    ...
    @Resource(lookup = "java:comp/DefaultJMSConnectionFactory") private static ConnectionFactory
            connectionFactory;
    @Resource(lookup = "jms/AQueue") private static Queue vendorOrderQueue;
    @Resource(lookup = "jms/CQueue") private static Queue vendorConfirmQueue;
    ...
    public static void main(String[] args) {
        ...
        try (JMSContext context = connectionFactory.createContext(JMSContext.SESSION_TRANSACTED);
             JMSContext asyncContext = context.createContext(JMSContext.SESSION_TRANSACTED);) {
            /*
            ...
            while (true) {
                try {
                    ...
                    System.out.println("Vendor: Ordered " + quantity + " CPU(s) and hard drive(s)");
