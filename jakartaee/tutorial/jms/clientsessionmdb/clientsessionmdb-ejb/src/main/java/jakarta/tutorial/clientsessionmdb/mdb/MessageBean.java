...
/**
 * The MessageBean class is a message-driven bean. It implements the jakarta.jms.MessageListener
 ...
 */
@JMSDestinationDefinition(name = "java:module/jms/newsTopic", interfaceName = "jakarta.jms.Topic",
                          destinationName = "PhysicalNewsTopic") @MessageDriven(activationConfig = {
...
public class MessageBean implements MessageListener {
    ...
    @Override public void onMessage(Message inMessage) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "MessageBean.onMessage: JMSException: {0}", e.toString());
            mdc.setRollbackOnly();
        }
    }
}
